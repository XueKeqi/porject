...
(function($) {
	...
	$.fn.extend({
		...
		uploader: function(options) {
			var settings = {
				url: '/shopxxb2b2c/admin/file/upload',
				fileType: "image",
				fileName: "file",
				data: {},
				maxSize: 10,
			...
			return this.each(function() {
				...
				var webUploader = WebUploader.create({
					swf: '/shopxxb2b2c/resources/admin/flash/webuploader.swf',
		...
		editor: function(options) {
			window.UEDITOR_CONFIG = {
				UEDITOR_HOME_URL: '/shopxxb2b2c/resources/admin/ueditor/',
				serverUrl: '/shopxxb2b2c/admin/file/upload',
...
(function($) {
	...
	$.fn.captchaImage.defaults = {
		...
		imgSrc: function(captchaIdParameterName, captchaId) {
			return "/shopxxb2b2c/common/captcha/image?" + captchaIdParameterName + '=' + captchaId + '&timestamp=' + new Date().getTime();
		},
		imgTitle: "点击更换验证码",
